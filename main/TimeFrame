...
public class TimeFrame {
    ...
    public void DisplayTime() throws IOException, ParseException {
        ...
        BufferedReader input = new BufferedReader(new FileReader("C:\\UM\\Fundamental of programming\\extracted_log"));
        String line;
        ...
        for(String key : time_Difference.keySet()){
            ...
            System.out.printf("%-8s"+" "+"%-35s"+"%-35s",key,time_Difference.get(key)[0],time_Difference.get(key)[1]);
            System.out.println("");
        }
    ...
    public void getTimeFrame() throws IOException, ParseException {
